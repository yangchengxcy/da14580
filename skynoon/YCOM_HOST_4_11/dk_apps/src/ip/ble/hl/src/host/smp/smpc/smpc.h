...
/// Security Manager Client Environments Pool
extern struct smpc_env_tag *smpc_env[SMPC_IDX_MAX];
...
/**
 ****************************************************************************************
 * @brief Create a new SMPC environment for the provided connection.
 *
...
/**
 ****************************************************************************************
 * @brief Destroy the SMPC environment linked to the provided connection.
 *
 * @param[in] conidx   Connection Index
 ****************************************************************************************
 */
...
/**
 ****************************************************************************************
 * @brief Send a SMPC_CMP_EVT message to the specified task id.
 *
 * @param[in] conidx      Connection Index
 * @param[in] cmd_src_id  Destination of the message
 * @param[in] operation   Operation code of the completed operation
 * @param[in] status      Status of the operation
 ****************************************************************************************
 */
void smpc_send_cmp_evt(uint8_t conidx, ke_task_id_t cmd_src_id,
