...
#define ROLE_MASTER_YCOM			1  //mack 
#if defined(CFG_APP_YCOM_PROX_HOST)
#define BLE_APP_YCOM_PROX_HOST 1
#else // defined(CFG_APP_ MYPROJECT)
#define BLE_APP_YCOM_PROX_HOST 0
#endif // defined(CFG_APP_ MYPROJ ECT)
...
enum KE_TASK_TYPE
{
    ...
    TASK_SPOTAR       = 65  ,   // SPOTA Receiver task
    TASK_STREAMDATAD  = 66  ,   // Stream Data Device Server task
    TASK_APP_BASC     = 68  ,
    TASK_APP_SCPPC    = 69  ,
