...
/*****************************************************************************************************************************************
 *
 * Rev.1 or Rev.2 DKs (keyboard #1 - UNUSED)
 *
 *****************************************************************************************************************************************/
...
const uint8_t kbd_input_ports[KBD_NR_INPUTS] = 
    {
        0x20,   // column 0
        0x21,   // column 1
        0x22,   // column 2
...
const uint8_t kbd_output_ports[KBD_NR_OUTPUTS] = 
    {
        0x00,   // row 0
        0x28,   // row 1
        0x29,   // row 2
        ...
        0x44,   // row 4 disabled (p04 == uart tx for printfs)
        0x45,   // row 5 disabled (p05 == uart tx for printfs)
    #else
        0x04,   // row 4
        0x05,   // row 5
    #endif
...
const uint16_t kbd_keymap[KBD_NR_SETS][KBD_NR_OUTPUTS][KBD_NR_INPUTS] = 
{
  { // No Fn keys pressed
...
const uint8_t kbd_output_ports[KBD_NR_OUTPUTS] = 
    ...
    #if defined(CFG_PRINTF) 
        0x44,   // row 4 disabled (p04 == uart tx for printfs)
        0x45,   // row 5 disabled (p05 == uart rx for printfs)
    #else
        0x04,   // row 4
        0x05,   // row 5
    #endif
...
const uint8_t kbd_input_ports[KBD_NR_INPUTS] = 
    {
    #if defined(CFG_PRINTF) 
        0x44,   // column 0 disabled (p04 == uart tx for printfs)
        0x45,   // column 1 disabled (p05 == uart tx for printfs)
    #else
        0x05,   // column 0 (P0[5])
        0x04,   // column 1
    #endif
...
const uint8_t kbd_input_ports[KBD_NR_INPUTS] = 
    {
        ...
        0x24,   // column 7
    #if defined(CFG_PRINTF) 
        0x45,   // column 8 disabled (p05 == uart rx for printfs)
    #else
        0x05,   // column 8
    #endif
        0x23,   // column 9
    #if defined(CFG_PRINTF) 
        0x44,   // column 10 disabled (p04 == uart tx for printfs)
    #else
        0x04,   // column 10
    #endif
        0x21,   // column 11
...
/*    No Fn key(s) pressed
      ...
      #         R-Win     p         o         k         u         -         ]         #(!Print) #Devices? End       Caps      #         #         #         #      
	...
	{ 0x0000,   0x0000,   0x0026,   0x0025,   0x000C,   0x0023,   0x0027,   0x002E,   0x0000,   K_CODE,   0x004A,   0x0000,   0x0000,   0x0000,   0xFC10,   0xFC20,  }, // 4
	{ 0x0000,   0xFC80,   0x0013,   0x0012,   0x000E,   0x0018,   0x002D,   0x0030,   0x0000,   K_CODE,   0x004D,   0x0039,   0x0000,   0x0000,   0x0000,   0x0000,  }, // 5
	{ 0x0000,   0x0000,   0x0033,   0x000F,   0x0024,   0x000D,   0x002F,   0x0000,   0x0047,   K_CODE,   0x004B,   0x002B,   0x0000,   0xFC40,   0x0000,   0x0000,  }, // 6
...
const uint8_t kbd_input_ports[KBD_NR_INPUTS] = 
    {
    #if defined(CFG_PRINTF) 
        0x45,   // column 0 disabled (p05 == uart tx for printfs)
        0x44,   // column 1 disabled (p04 == uart tx for printfs)
    #else
        0x05,   // column 0 (P0[5])
        0x04,   // column 1
    #endif
...
/*    No Fn key(s) pressed
      ...
      a         s         d         q         w         e         Up arrow  Lft arrow Dn arrow  Rgt arrow   #???      #???      'Fn'      Space     F5        F6        Pause     Tab
	...
	{ 0x0004,   0x0016,   0x0007,   0x0014,   0x001A,   0x0008,   0x0052,   0x0050,   0x0051,   0x004F,     0x0000,   0x0000,   0xF801,   0x002C,   0x003E,   0x003F,   0x0048,   0x002B }, // 1
	...
	{ 0x000A,   0x000B,   0x0034,   0x0000,   0x0049,   0x004E,   0x0059,   0x005A,   0x005B,   0x0058,     0x0000,   0x0000,   0xFC20,   0x0000,   0x0000,   0x0000,   0xFC02,   0x0000 }, // 6
...
/*    Fn key 0x01 pressed
	...
	{ 0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,     0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0xF801,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,  }, // 1
	{ 0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,     0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,   0x0000,  }, // 2
