...
****************************************************************************************
*
* @file app_smarttag_proj.h
*
* @brief Smart Tag Project application header file.
*
...
#ifndef APP_SMARTTAG_PROJ_H_
#define APP_SMARTTAG_PROJ_H_
