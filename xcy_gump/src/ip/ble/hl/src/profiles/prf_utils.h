...
#define PRF_CLIENT_RESET(envs, type) \
        (prf_client_reset((prf_env_struct ***)&(envs), TASK_ ## type, type ## _IDLE, &TASK_DESC_ ## type))
...
#define PRF_CLIENT_DISABLE_IND_SEND(envs, task_id, type, conhdl) \
        (prf_client_disable_ind_send((prf_env_struct ***)&envs, type ## _DISABLE_IND, task_id, type ## _IDLE, (conhdl)))
