...
#include "arch.h"          		  // stack configuration
...
enum prevent_sleep
{
    ...
    RW_HCI_TX_ONGOING = 0x0002,
    RW_GTL_TX_ONGOING = 0x0002,
    /// Flag indicating that an HCI RX transfer is ongoing
    RW_HCI_RX_ONGOING = 0x0004,
    RW_GTL_RX_ONGOING = 0x0004,
    /// Flag indicating HCI timeout is ongoing
    RW_HCI_TIMEOUT = 0x0008,
