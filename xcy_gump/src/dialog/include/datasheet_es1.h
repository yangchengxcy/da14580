#ifndef _IO14580_INCLUDED
#define _IO14580_INCLUDED
 ...
 *----------------------------------------------------------------------------------------------------------------------------------------
 * 
 * Description : Definition of the memory map and registers.
 *
 * File:      sc14580.h
 * Generated: Mon Dec 17 13:20:53 CET 2012
 * By:        moschopoulos					    
 * Country:   The Netherlands
 *
 *------------------------------------------------------------------------------------------------------------------------
 * Header    : $Header: /services/syncdata/hazelaar/8000/server_vault/bb/tester/development/software_include/sc14580a/datasheet.h.rca 1.85 Mon Dec 17 13:23:04 2012 moschopoulos Experimental $
 * Date      : $Date: Mon Dec 17 13:23:04 2012 $
 *
 *------------------------------------------------------------------------------------------------------------------------
 * 
 *  Id       : $Id: datasheet.h.rca 1.85 Mon Dec 17 13:23:04 2012 moschopoulos Experimental $
 *
 *  Log      : $Log: datasheet.h.rca $
 *  Log      : 
 *  Log      :  Revision: 1.85 Mon Dec 17 13:23:04 2012 moschopoulos
 *  Log      :  corrected the tilde at the GetBits16 and 32 definition
 *
 *------------------------------------------------------------------------------------------------------------------------
 */
...
/******  SC14580 Specific Interrupt Numbers ***************************************************/
  ...
  WUPCT_IRQn                    = 9,      /* Wakeup Capture Timer interrupt. Generated when a programmable threshold of events occure on a GPIO (also programmable).         */
  BLE_RADIOCNTL_IRQn            = 10,     /* BLE radio interrupt.                                                                                                            */
...
/* This file is generated from the XML files Output/TMS580.xml Output/reg_file.xml  */
/* On 2012-12-17T13:20:53 */
...
#define RF_RADIG_SPARE_REG                       (0x50002866) /*  */
...
#define RF_VCO_CTRL_REG                          (0x50002C10) /*  */
...
/*=============================*/
{
    ...
    WORD BITFLD_VCO_FREQTRIM_RD      : 3;
};

#define GAUSS_GAIN_CAL_RD    (0x00FF)
#define VCO_FREQTRIM_RD      (0x0700)
...
/*=============================*/
{
    ...
    WORD BITFLD_iff_bias_en          : 8;
};

#define vco_bias_en          (0x00FF)
#define iff_bias_en          (0xFF00)
...
/*=============================*/
{
    WORD BITFLD_mix_bias_en          : 8;
    WORD BITFLD_cp_bias_en           : 8;
};

#define mix_bias_en          (0x00FF)
...
/*=============================*/
{
    WORD BITFLD_lobuf_md_en          : 8;
    WORD BITFLD_lobuf_rxiq_en        : 8;
};

#define lobuf_md_en          (0x00FF)
...
/*=============================*/
{
    WORD BITFLD_spare_en2            : 8;
    WORD BITFLD_spare_en1            : 8;
};

#define spare_en2            (0x00FF)
#define spare_en1            (0xFF00)
...
#define MIX_TRIM_IBIAS       (0x000F)
#define MIX_TRIM_VCM         (0x00F0)
#define MIX_TRIM_GMBIAS      (0x0F00)
...
/*=============================*/
{
    WORD BITFLD_MODVAL_SEL           : 14;
    WORD BITFLD_MODVAL_WR            : 1;
};

#define MODVAL_SEL           (0x3FFF)
#define MODVAL_WR            (0x4000)
...
/*=============================*/
{
    WORD BITFLD_VCO_FREQTRIM_WR      : 3;
    WORD BITFLD_VCO_FREQTRIM_SEL     : 1;
    WORD BITFLD_VCOCAL_PERIOD        : 2;
};

#define VCO_FREQTRIM_WR      (0x0007)
#define VCO_FREQTRIM_SEL     (0x0008)
#define VCOCAL_PERIOD        (0x0030)
...
#define GP_ADC_REG                               (0x50001500) /* general-purpose ADC */
#define GP_ADC_RESULT_REG                        (0x50001506) /* last result of the general-purpose ADC */
...
#define DCDC_CAL1_REG                            (0x50001620) /* calibration for comparators in dcdc */
#define DCDC_CAL2_REG                            (0x50001622) /* calibration for comparators in dcdc */
#define DCDC_CAL3_REG                            (0x50001624) /* calibration for comparators in dcdc */
#define ANA_TEST_REG                             (0x500033F2) /* test bits for analog */
...
/*=============================*/
{
    WORD BITFLD_DCDC_CAL1            : 16;
};

#define DCDC_CAL1            (0xFFFF)
...
/*=============================*/
{
    WORD BITFLD_DCDC_CAL2            : 16;
};

#define DCDC_CAL2            (0xFFFF)
...
/*=============================*/
{
    WORD BITFLD_DCDC_CAL3            : 16;
};

#define DCDC_CAL3            (0xFFFF)



/*=============================*/
struct __ANA_TEST_REG
/*=============================*/
{
    WORD BITFLD_ANA_TEST             : 16;
};

#define ANA_TEST             (0xFFFF)
...
#define BLE_CNTL2_REG                            (0x40000200) /* Configuration register 2 */
#define BLE_CNTL3_REG                            (0x40000204) /* Configuration register 3 */
...
/*=============================*/
{
    WORD BITFLD_OSC_SLEEP_EN         : 1;
    WORD BITFLD_RADIO_SLEEP_EN       : 1;
...
#define OSC_SLEEP_EN         (0x0001)
#define RADIO_SLEEP_EN       (0x0002)
...
{
    WORD BITFLD_TWRM                 : 10;
    WORD BITFLD_TWOSC                : 11;
    WORD BITFLD_TWEXT                : 11;
};

#define TWRM                 (0x03FF)
#define TWOSC                (0x1FFC00)
...
#define BUCK_CTRL_REG                            (0x50000024) /* settings for buck converter */
#define BOOST_CTRL_REG                           (0x50000026) /* settings for boost converter */
...
/*=============================*/
struct __BUCK_CTRL_REG
/*=============================*/
{
    WORD BITFLD_BUCK_ENABLE          : 1;
    WORD BITFLD_BUCK_TON             : 3;
    WORD BITFLD_BUCK_TON_MAX         : 2;
    WORD BITFLD_BUCK_LEVEL           : 4;
    WORD BITFLD_BUCK_CAL             : 1;
};

#define BUCK_ENABLE          (0x0001)
#define BUCK_TON             (0x000E)
#define BUCK_TON_MAX         (0x0030)
#define BUCK_LEVEL           (0x03C0)
#define BUCK_CAL             (0x0400)



/*=============================*/
struct __BOOST_CTRL_REG
/*=============================*/
{
    WORD BITFLD_SOLAR_LEVEL          : 3;
    WORD BITFLD_BOOST_LEVEL_VBAT     : 3;
    WORD BITFLD_BOOST_LEVEL_VDCDC    : 3;
    WORD BITFLD_BOOST_CAL            : 1;
};

#define SOLAR_LEVEL          (0x0007)
#define BOOST_LEVEL_VBAT     (0x0038)
#define BOOST_LEVEL_VDCDC    (0x01C0)
#define BOOST_CAL            (0x0200)
...
#define P2_PADPWR_CTRL_REG                       (0x50003072) /* Port 2 Output Control Power Register */
...
#define I2C_DMA_RDLR_REG                         (0x50001390) /* DMA Receive Data Level Register */
...
/*=============================*/
{
    WORD BITFLD_DMARDL               : 1;
};

#define DMARDL               (0x0001)
...
/*=============================*/
{
    WORD BITFLD_INPUT_SEL            : 4;
    WORD BITFLD_WUP_DEB_VALUE        : 6;
    WORD BITFLD_LEVEL                : 1;
    WORD BITFLD_ENABLE_IRQ           : 1;
};

#define INPUT_SEL            (0x000F)
#define WUP_DEB_VALUE        (0x03F0)
#define LEVEL                (0x0400)
#define ENABLE_IRQ           (0x0800)
...
#define OTPC_MODE_REG                            (0x40004000) /* Mode register */
#define OTPC_PCTRL_REG                           (0x40004004) /* Bit-programming control register */
#define OTPC_STAT_REG                            (0x40004008) /* Status register */
#define OTPC_AHBADR_REG                          (0x4000400C) /* AHB master start address */
#define OTPC_CELADR_REG                          (0x40004010) /* Macrocell start address */
#define OTPC_NWORDS_REG                          (0x40004014) /* Number of words */
#define OTPC_FFPRT_REG                           (0x40004018) /* Ports access to fifo logic */
#define OTPC_FFRD_REG                            (0x4000401C) /* The data which have taken with the latest read from the */
...
#define PATCH_VALID_REG                          (0x40004400) /* Validity Control Register */
#define PATCH_VALID_SET_REG                      (0x40004404) /* Validity Set Control Register */
#define PATCH_VALID_RESET_REG                    (0x40004408) /* Validity Reset Control Register */
#define PATCH_ADDR0_REG                          (0x40004410) /* Patch entry 0: Address field */
#define PATCH_DATA0_REG                          (0x40004414) /* Patch entry 0: Data field */
#define PATCH_ADDR1_REG                          (0x40004418) /* Patch entry 1: Address field */
#define PATCH_DATA1_REG                          (0x4000441C) /* Patch entry 1: Data field */
#define PATCH_ADDR2_REG                          (0x40004420) /* Patch entry 2: Address field */
#define PATCH_DATA2_REG                          (0x40004424) /* Patch entry 2: Data field */
#define PATCH_ADDR3_REG                          (0x40004428) /* Patch entry 3: Address field */
#define PATCH_DATA3_REG                          (0x4000442C) /* Patch entry 3: Data field */
#define PATCH_ADDR4_REG                          (0x40004430) /* Patch entry 4: Address field */
#define PATCH_DATA4_REG                          (0x40004434) /* Patch entry 4: Data field */
#define PATCH_ADDR5_REG                          (0x40004438) /* Patch entry 5: Address field */
#define PATCH_DATA5_REG                          (0x4000443C) /* Patch entry 5: Data field */
#define PATCH_ADDR6_REG                          (0x40004440) /* Patch entry 6: Address field */
#define PATCH_DATA6_REG                          (0x40004444) /* Patch entry 6: Data field */
#define PATCH_ADDR7_REG                          (0x40004448) /* Patch entry 7: Address field */
#define PATCH_DATA7_REG                          (0x4000444C) /* Patch entry 7: Data field */
...
/*=============================*/
{
    ...
    WORD BITFLD_CHX_PORT_SEL         : 3;
    WORD BITFLD_CHY_PORT_SEL         : 3;
};
...
#define CHX_PORT_SEL         (0x1C00)
#define CHY_PORT_SEL         (0xE000)
