...
/*===========================================================================*/ 
// register CHIP_TEST1_REG found for which all fields are reserved, ommiting.
// register CHIP_TEST2_REG found for which all fields are reserved, ommiting.
...
#define CLK_RCX20K_REG                       (0x50000024) /* bla */
...
#define XTAL16_BIAS_SH_DISABLE               (0x0100)
...
#define WKUP_POL_P0_REG                      (0x50000112) /* select the sesitivity polarity for each P0 input */
#define WKUP_POL_P1_REG                      (0x50000114) /* select the sesitivity polarity for each P1 input */
#define WKUP_POL_P2_REG                      (0x50000116) /* select the sesitivity polarity for each P2 input */
#define WKUP_POL_P3_REG                      (0x50000118) /* select the sesitivity polarity for each P3 input */
