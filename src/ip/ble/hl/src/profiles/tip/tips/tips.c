...
struct tips_env_tag tips_env __attribute__((section("exchange_mem_case1"))); //@WIKRETENTION MEMORY 
struct tips_idx_env_tag **tips_idx_envs __attribute__((section("exchange_mem_case1"))); //@WIKRETENTION MEMORY 
