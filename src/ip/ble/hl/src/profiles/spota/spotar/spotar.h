...
enum
{
    ...
    SPOTAR_CRC_ERR          = 0x04,     // Overal Patch Data CRC failed
    SPOTAR_PATCH_LEN_ERR    = 0x05,     // Received patch Length not equal to PATCH_LEN characteristic value
    SPOTAR_EXT_MEM_ERR      = 0x06,     // External Mem Error (Writing to external device failed)
...
/// SPOTA Service
extern const att_svc_desc_t spotar_svc;

/// SPOTA Service - Patch Memory Device Characteristic
extern const struct att_char_desc spotar_patch_mem_dev_char;

/// SPOTA Service - GPIO mapping Characteristic
extern const struct att_char_desc spotar_gpio_map_char;

/// SPOTA Service - Patch Memory Device Information Characteristic
extern const struct att_char_desc spotar_patch_mem_info_char;

/// SPOTA Service - Patch Length Characteristic
extern const struct att_char_desc spotar_patch_len_char;

/// SPOTA Service - Patch Data Characteristic
extern const struct att_char_desc spotar_patch_data_char;

/// SPOTA Service - Patch Status Characteristic
extern const struct att_char_desc spotar_patch_status_char;
