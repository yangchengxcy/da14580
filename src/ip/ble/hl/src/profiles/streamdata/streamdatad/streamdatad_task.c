...
/// Data Characteristic
static const struct att_char_desc streamdatad_d0_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D0_UUID);
static const struct att_char_desc streamdatad_d1_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D1_UUID);
static const struct att_char_desc streamdatad_d2_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D2_UUID);
static const struct att_char_desc streamdatad_d3_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D3_UUID);
static const struct att_char_desc streamdatad_d4_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D4_UUID);
static const struct att_char_desc streamdatad_d5_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D5_UUID);
static const struct att_char_desc streamdatad_d6_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D6_UUID);
static const struct att_char_desc streamdatad_d7_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D7_UUID);
static const struct att_char_desc streamdatad_d8_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D8_UUID);
static const struct att_char_desc streamdatad_d9_char = ATT_CHAR(ATT_CHAR_PROP_RD | ATT_CHAR_PROP_WR | ATT_CHAR_PROP_NTF, 0, STREAMDATAD_D9_UUID);
/// Enable description
                                   ...
                                   ke_task_id_t const src_id)
{
	...
	{
		// ERROR overflow
		// This can happen if there are SEND_DATA_REQ packets in-flight when a LLC_NB_PKT_CMP_EVT comes in, or
		// this can also happen there are fewer notification-enabled attributes than there are transmit buffers.
		
		// We'll copy the data for later transmission
		memcpy(&(streamdatad_env.overflow_packets[streamdatad_env.nr_overflow_packets][0]), &(param->packets[next_packet][0]), STREAMDATAD_PACKET_SIZE);
		if (streamdatad_env.nr_overflow_packets < STREAMDATAD_MAX) ++streamdatad_env.nr_overflow_packets;
	}
#endif
    return (KE_MSG_CONSUMED);
}
...
ke_state_t streamdatad_state[STREAMDATAD_IDX_MAX]; // __attribute__((section("exchange_mem_case1")));
