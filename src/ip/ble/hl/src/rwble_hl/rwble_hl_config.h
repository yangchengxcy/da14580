...
#define APP_SEC_TASK        jump_table_struct[app_sec_task_pos]//TASK_APP_SEC
#else // BLE_APP_PRESENT
#define APP_MAIN_TASK       jump_table_struct[FLAG_FULLEMB_POS]//TASK_GTL
#define APP_SEC_TASK        jump_table_struct[app_sec_task_pos]//TASK_GTL
...
#define BLE_GAPC                    1
#define BLE_GAPC_HEAP_ENV_SIZE      (sizeof(struct gapc_env_tag) + 4)
...
#define BLE_GATTM     1
#define BLE_GATTC     1
#define BLE_GATTC_HEAP_ENV_SIZE     (sizeof(struct gattc_env_tag) + 4)
#else //(BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_L2CM      0
#define BLE_L2CC      0
#define BLE_ATTM      0
...
#if (BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_SMPC      1
#define BLE_SMPC_HEAP_ENV_SIZE      0 // TODO [FBE] add it as soon as available (sizeof(struct smpc_env_tag) + 4)
#else //(BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_SMPC      0
...
/******************************************************************************************/
    ...
    /// Sample128 Profile. Sample profile with 128bit UUID svc/char/val
    #if defined(CFG_PRF_SAMPLE128)
        #define BLE_SAMPLE128       1
    #else
        #define BLE_SAMPLE128       0
    #endif // defined(CFG_PRF_SAMPLE128)
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
	...
	|| BLE_RSC_COLLECTOR || BLE_CSC_COLLECTOR || BLE_AN_CLIENT || BLE_PAS_CLIENT)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
    ...
    || BLE_TIP_SERVER || BLE_HR_SENSOR || BLE_DIS_SERVER || BLE_ACCEL || BLE_SP_SERVER || BLE_SPOTA_RECEIVER \
    || BLE_BATT_SERVER || BLE_HID_DEVICE || BLE_GL_SENSOR || BLE_NEB_SERVER \
    || BLE_RSC_SENSOR || BLE_CSC_SENSOR || BLE_AN_SERVER || BLE_PAS_SERVER)
...
/// Attribute Server
    ...
    #define BLE_ATTS                    1
    #define BLE_ATTS_HEAP_ENV_SIZE      (sizeof(struct atts_env_tag) + 4)
#else
    #define BLE_ATTS                    0
