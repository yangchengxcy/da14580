...
/* Packet partition */
#define L2C_CID_LEN                         0x0002
#define L2C_LENGTH_LEN                      0x0002
#define L2C_CODE_LEN                        0x0001
/*L2C_CID_LEN+L2C_LENGTH_LEN*/
#define L2C_HEADER_LEN                      0x0004
#define L2C_MAX_PAYLOAD_LEN                 0xFFFF
...
/* MTU signaling default value = 23 octets */
#define L2C_MAX_LE_MTUSIG                   0x0017
...
#define L2C_QOS_BEST_EFFORT                 0x01
...
/* Flag for packet identifier */
#define L2C_RESET_ID                        0x00
#define L2C_NEW_ID                          0x01
#define L2C_RESP_ID                         0x02
...
#define L2C_PB_CMPLT_L2CAP                  0x03
/* Host to controller broadcast flag */
#define L2C_BC_DISABLED                     0x00
#define L2C_BC_ACTIVE_SLAVE_BROADCAST       0x01
#define L2C_BC_PARKED_SLAVE_BROADCAST       0x02
/* Flag for connection handle function */
#define L2C_RST_HDL_CNT                     0x00
#define L2C_GET_HDL_CNT                     0x01
#define L2C_INC_HDL_CNT                     0x02
#define L2C_DEC_HDL_CNT                     0x03
...
struct l2cc_att_rd_mult_req
{
    ...
    uint16_t    handles[ATT_MAX_VALUE/2];
};
 ...
 *
 * @param[in]  pdu    PDU input data unpacked
 * @param[out] buffer output buffer where data is packed.
 *
 * @return L2C_ERR_NO_ERROR if packing succeed, else another error code.
 ****************************************************************************************
 */
uint8_t l2cc_pdu_pack(struct l2cc_pdu* pdu, uint8_t* buffer);

/**
 ****************************************************************************************
 * Unpack L2Cap PDU in a generic format that can be used by firmware using generic method.
 *
 * @param[out] pdu    PDU output data unpacked
 * @param[in]  buffer input buffer where data is packed.
 *
 * @return L2C_ERR_NO_ERROR if packing succeed, else another error code.
 ****************************************************************************************
 */
uint8_t l2cc_pdu_unpack(struct l2cc_pdu* pdu, const uint8_t* buffer);
