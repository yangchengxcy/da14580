...
/**
 ****************************************************************************************
 * @brief Retrieves attribute code from L2CC data message.
 *
 * @param[in] buf_ptr   pointer to the data buffer where to fetch the code
 *
 ...
 */
uint8_t
attm_retrieve_code(uint8_t *buf_ptr);
