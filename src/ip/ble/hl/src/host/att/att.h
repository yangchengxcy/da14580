...
enum {
    ...
    /// Nebulizer - Proprietary
    ATT_SVC_NEBULIZER                           = 0xFF00,
    ...
    /******************************************************************
     * NEBULIZER PROFILE - PROPRIETATY
     ******************************************************************/
    ATT_CHAR_NEB_RECORD                         = 0xFFA0,
    ATT_CHAR_NEB_FEATURES                       = 0xFFA1,
    ATT_CHAR_NEB_RECORD_CTNL_PT                 = 0xFFA2,
    ATT_CHAR_NEB_INSP_THRES                     = 0xFFA3,
    ATT_CHAR_NEB_ALERT                          = 0xFFA4,
