...
{
//#if ((MATRIX_SETUP != 5) && (MATRIX_SETUP != 6))   
#if 0   
	#define REPORT_MAP_LEN (65 + 71)
...
#else // (MATRIX_SETUP == 5) || (MATRIX_SETUP == 6)
