...
uint8_t accel_adv_interval1 __attribute__((section("exchange_mem_case1"))) = 30;	//GZ
uint8_t accel_adv_interval2 __attribute__((section("exchange_mem_case1"))) = 0;
uint8_t accel_adv_interval3 __attribute__((section("exchange_mem_case1"))) = 0;

uint8_t accel_con_interval __attribute__((section("exchange_mem_case1"))) = 10;

uint8_t accel_mode __attribute__((section("exchange_mem_case1"))) = 0;
uint8_t accel_latency __attribute__((section("exchange_mem_case1"))) = 0x8;
uint8_t accel_window __attribute__((section("exchange_mem_case1"))) = 0xFF;
