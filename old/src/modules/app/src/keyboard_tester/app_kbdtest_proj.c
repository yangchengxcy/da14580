...
uint8_t hids_nb  __attribute__((section("exchange_mem_case1")));
struct hogprh_hids_content hids[HOGPRH_NB_HIDS_INST_MAX]  __attribute__((section("exchange_mem_case1")));
