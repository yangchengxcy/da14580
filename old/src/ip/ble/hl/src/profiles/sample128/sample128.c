...
/// sample128_1 Service
const struct att_uuid_128 sample128_1_svc     = {{0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F}};
...
void sample128_disable(void)
{
    ...
    attmdb_svc_set_permission(sample128_env.sample128_1_shdl, PERM_RIGHT_DISABLE);
    ...
    attmdb_att_get_value(sample128_env.sample128_1_shdl + SAMPLE128_1_IDX_VAL,
                         &length, &alert_lvl);
