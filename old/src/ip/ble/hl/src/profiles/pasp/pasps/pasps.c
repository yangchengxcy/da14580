...
struct pasps_env_tag pasps_env __attribute__((section("exchange_mem_case1"))); //@WIKRETENTION MEMORY 
/// Phone Alert Status Profile Server Environment Variable
struct pasps_idx_env_tag **pasps_idx_envs __attribute__((section("exchange_mem_case1"))); //@WIKRETENTION MEMORY 
