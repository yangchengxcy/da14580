...
typedef uint8_t tip_day_of_week;

///Day Date Time Characteristic Structure - UUID:0x2A0A
struct tip_day_date_time
{
    struct prf_date_time date_time;
    tip_day_of_week day_of_week;
};

///Exact Time 256 Characteristic Structure - UUID:0x2A0C
struct tip_exact_time_256
{
    struct tip_day_date_time day_date_time;
    ///1/256th of a second
...
{
    struct tip_exact_time_256 exact_time_256;
...
#endif /* #if (BLE_TIP_CLIENT || BLE_TIP_SERVER) */
