...
extern uint8_t accel_adv_interval1 __attribute__((section("exchange_mem_case1")));	//GZ
extern uint8_t accel_adv_interval2 __attribute__((section("exchange_mem_case1")));
extern uint8_t accel_adv_interval3 __attribute__((section("exchange_mem_case1")));

extern uint8_t accel_con_interval __attribute__((section("exchange_mem_case1")));

extern uint8_t accel_mode __attribute__((section("exchange_mem_case1")));
extern uint8_t accel_latency __attribute__((section("exchange_mem_case1")));
extern uint8_t accel_window __attribute__((section("exchange_mem_case1")));
...
ke_state_t accel_state[ACCEL_IDX_MAX] __attribute__((section("exchange_mem_case1"))); //@WIKRETENTION MEMORY 
