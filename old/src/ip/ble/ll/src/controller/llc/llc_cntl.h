...
/**
 ****************************************************************************************
 * @brief Sends the reject indication pdu.
 *
 ...
 ****************************************************************************************
 */
void llc_reject_ind_pdu_send(uint16_t conhdl, uint8_t reason);
 ...
 ****************************************************************************************
 */
void llc_enc_req_pdu_send(uint16_t conhdl, struct llc_le_start_enc_cmd const *param);
...
/**
 ****************************************************************************************
 * @brief Handles the reject indication pdu.
 *
 * This function extracts the parameters from the control packet received and takes the
 * associated actions (new pdu generation, new state , parameters update, etc...).
 *
 ...
 ****************************************************************************************
 */
void llc_reject_ind(uint16_t conhdl, struct llcp_reject_ind const *param);
