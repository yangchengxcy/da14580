...
#include "hcic_uart.h"        // hci uart definition
...
#else
///Maximum number of HCI commands
#define HCI_CMD_OPCODE_NB_MAX      70
...
/**
 ****************************************************************************************
 * @brief Function called in HCI UART reception routine to allocate a KE message for a
 *        command.
 *
...
/**
 ****************************************************************************************
 * @brief Function called in HCI UART reception routine to dispatch a KE message for a
...
/**
 ****************************************************************************************
 * @brief Function called in HCI UART reception routine to dispatch a KE message for data
