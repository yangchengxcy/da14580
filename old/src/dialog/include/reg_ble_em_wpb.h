...
#define REG_BLE_EM_WPB_ADDR_GET(idx) (jump_table_struct[offset_em_wpb] + (idx) * REG_BLE_EM_WPB_SIZE)
 ...
 * </pre>
 */
//#define BLE_WLPUB_ADDR   (0x50008000 + EM_BLE_WPB_OFFSET)
//#define BLE_WLPUB_ADDR   (0x80000 + EM_BLE_WPB_OFFSET)
#define BLE_WLPUB_ADDR   (0x80000 + jump_table_struct[offset_em_wpb])  //@wik
