...
#define REG_BLE_EM_WPV_ADDR_GET(idx) (jump_table_struct[offset_em_wpv] + (idx) * REG_BLE_EM_WPV_SIZE)
 ...
 * </pre>
 */
//#define BLE_WLPRV_ADDR   (0x50008000 + EM_BLE_WPV_OFFSET)
#define BLE_WLPRV_ADDR   (0x80000 + jump_table_struct[offset_em_wpv]) //@wik
